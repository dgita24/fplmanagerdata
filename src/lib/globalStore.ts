...
export const globalCache = {
  ...
  squads: {
    data: new Map<string, any>(), // key: "entryId:gw"
    history: new Map<string, any>(), 
  },
  transfers: {
    history: new Map<number, any>(), // key: entryId
  },
  ownership: {
    squads: new Map<string, any>(), // key: "entryId:gw"
  },
  chips: {
    data: new Map<number, any>(), // key: entryId
  },
  stats: {
